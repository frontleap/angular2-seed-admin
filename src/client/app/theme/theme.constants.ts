export const IMAGES_ROOT = 'src/client/assets/img/';
...
export const layoutPaths = {
  images: {
    ...
    amMap: 'src/client/assets/img/theme/vendor/ammap/',
    amChart: 'src/client/assets/img/theme/vendor/amcharts/dist/amcharts/images/'
  }
};
